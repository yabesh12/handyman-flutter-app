                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(" ${widget.forProvider ? widget.data.providersServiceRating.validate().toStringAsPrecision(1) : widget.data.handymanRating.validate().toStringAsFixed(1)}", style: secondaryTextStyle(size: 12, weight: FontWeight.bold)),
                      ],
                    ),
                    Center(
                      child: TextButton(
