...
import 'package:booking_system_flutter/utils/mock_data.dart';
...
// Demo mode flag - set to false to use real API data
...
class _DashboardFragmentState extends State<DashboardFragment> {
  ...
  void init() async {
    if (DEMO_MODE) {
      // Use static mock data in demo mode
      future = Future.value(MockData.getMockDashboardResponse());
    } else {
